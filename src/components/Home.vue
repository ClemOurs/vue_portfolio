<template>
    <div class="header-container column center-total">
        <h1 class="gradient">Hi, I'm Clément Duvivier.</h1>
        <div class="find-me row center">
            <img id="location" src="@/assets/logos/location.png" alt="location">
